...
class Conv2dShiftQ(_ConvNdShiftQ):
    ...
    def forward(self, input, ratio_out=1, ratio_in=1, ratio_g=1, kernel=None):
        ...
        if self.use_kernel:
            ...
            sample_weight = weight_q[:(self.out_channels//ratio_out),:(self.in_channels//ratio_in),:,:]
            if (kernel!=None):
                ...
                padding = self.padding
            return torch.nn.functional.conv2d(input_padded, sample_weight, bias_fixed_point,
