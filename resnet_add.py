...
def conv3x3(in_planes, out_planes, stride=1, gruops=1, quantize=False, weight_bits=8, sparsity=0, quantize_v='sbm'):
    " 3x3 convolution with padding "
    return adder.Adder2D(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, groups=gruops, bias=False,
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, quantize=False, weight_bits=8, sparsity=0, quantize_v='sbm'):
        ...
        self.conv2 = conv3x3(planes, planes, gruops=2, quantize=quantize, weight_bits=weight_bits, sparsity=sparsity, quantize_v=quantize_v)
